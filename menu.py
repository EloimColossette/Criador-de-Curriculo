...
class Janela_Menu(tk.Tk):
    ...
    def _criar_sidebar(self):
        """Cria a sidebar de navegação com fundo em azul escuro."""
        # Cor da sidebar: tom de azul escuro
    ...
    def _criar_menu_lateral(self):
        ...
        # 1) Frame de usuário
        user_frame = tk.Frame(self.sidebar, bg="#1a252f", bd=2, relief="ridge")
        user_frame.place(x=10, y=10, width=200, height=60)
        user_label = tk.Label(
            user_frame,
        ...
        # 2) Separador
        separator = tk.Frame(self.sidebar, bg="#95a5a6", height=2)
        separator.place(x=10, y=80, width=200)
        ...
        # 4) Dados de botões (nome_interno, comando)
        buttons_data = [
        ...
        for internal_name, command in buttons_data:
            if internal_name in self.permissoes:
                ...
                button.place(x=10, y=y_coord, width=200)
                # armazena posição original
                button._default_y = y_coord

                # Sombra
                shadow = tk.Label(self.sidebar, bg="#2471a3")
                shadow.place(x=12, y=y_coord + 2, width=200, height=40)
                shadow.lower()
                shadow._default_y = y_coord + 2
                ...
                # Guarda tupla para uso no atualizar_pagina()
