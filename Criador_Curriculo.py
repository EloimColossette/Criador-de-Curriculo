...
class CVGeneratorApp(tk.Tk):
    ...
    def _create_widgets(self):
        ...
        labels = ['Nome Completo', 'Data de Nascimento', 'Estado Civil', 'Carteira de Motorista', 'Cargo / Título', 'Localização', 'E-mail', 'Telefone', 'LinkedIn', 'GitHub']
        self.entries = {}
        ...
        self.exp = SectionFrame(content, 'Experiência Profissional', {'Empresa': False, 'Cargo': False, 'Período': False, 'Descrição': True})
        self.exp.grid(row=2, column=0, columnspan=3, sticky='nsew')

        self.edu = SectionFrame(content, 'Formação Acadêmica', {'Escola': False, 'Curso': False, 'Período': False, 'Descrição': True})
        ...
        btn = ttk.Button(container, text='Gerar PDF', style='Accent.TButton', command=self._generate_pdf)
